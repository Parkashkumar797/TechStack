        ...
        <>
            <div className='container 2xl:px-20 mx-auto flex flex-col lg:flex-row max-lg:space-y-8 py-8'>
                ...
                <div className='w-full lg:w-1/4 bg-white px-4'>
                        ...
                        <>
                            ...
                            <div className='mb-4 text-gray-600'>
                                ...
                                {searchFilter.location && (
                                    <span ml-2 className='inline-flex items-center gap-2.5 bg-red-50 border border-red-200 px-4 py-1.5 rounded'>
                                        {searchFilter.location}
                    ...
                    <button onClick={e => setShowFilter(prev => !prev)} className='px-6 py-1,6 rounded  border border-gray-400 lg:hidden'>
                    ...
                    {/* location filter */}
                    <div className={showFilter ? "" : "max-lg:hidden"}>
                        <h3 className='font-medium text-lg py-4 pt-8 '>
                            Search By Location
                            <ul className='py-4 text-gray-600'>
                                {
                ...
                {/* job Listing  */}
                <section className='w-full ld:w-3/4 text-gray-800 max-lg:px-4'>
